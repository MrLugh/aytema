...
<head>
    ...
    echo $this->Html->css('themes/space/admin');
    ?>
    ...
    echo $this->Html->script('angular/app/controllers/admin/width');
        ...
        echo $this->Html->script('angular/app/controllers/themes/space');
        echo $this->Html->script('angular/app/controllers/themes/space/content');
    ?>
    ...
    echo $this->Html->script('angular/app/directives/admin/width');
        // Themes
        echo $this->Html->script('angular/app/directives/themes/space/index');
        echo $this->Html->script('angular/app/directives/themes/space/content');
    ?>
...
<body>
    ...
    <div data-ng-app="ayTemaThemeApp" controller='themeSpaceCo' user='<?php echo $user; ?>' resize>
        <ng-view></ng-view>
    </div>
