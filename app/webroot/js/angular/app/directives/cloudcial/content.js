...
function($FB,$timeout,appSv,$window){
    return {
        templateUrl : getPath('tpl')+'/cloudcial/video.html',
        restrict : 'E',
        replace : true,
...
function(appSv,$window,$timeout){
    return {
        templateUrl : getPath('tpl')+'/cloudcial/photo.html',
        restrict : 'E',
        replace : true,
...
ayTemaDs.directive('contentTrack',[function(){
    ...
    return {
        templateUrl : getPath('tpl')+'/cloudcial/track.html',
        restrict : 'E',
        replace : true,
...
ayTemaDs.directive('contentChat',[function(){
    ...
    return {
        templateUrl : getPath('tpl')+'/cloudcial/chat.html',
        restrict : 'E',
        replace : true,
...
ayTemaDs.directive('contentQuote',[function(){
    ...
    return {
        templateUrl : getPath('tpl')+'/cloudcial/quote.html',
        restrict : 'E',
        replace : true,
...
function($FB,$timeout){    
    return {
        templateUrl : getPath('tpl')+'/cloudcial/post.html',
        restrict : 'E',
        replace : true,
...
function(appSv,$window){
    ...
    return {
        templateUrl : getPath('tpl')+'/cloudcial/link.html',
        restrict : 'E',
        replace : true,
...
function(appSv,$window){
    ...
    return {
        templateUrl : getPath('tpl')+'/cloudcial/event.html',
        restrict : 'E',
        replace : true,
